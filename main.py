...
# === Telegram: отправка через Bot API напрямую ===
...
def send_telegram_message(text: str):
    """Отправка сообщения через Telegram Bot API (без библиотеки)."""
...
# === Bybit + индикаторы — без изменений ===
...
if __name__ == "__main__":
    print("🚀 Запуск бота (без python-telegram-bot)...")
